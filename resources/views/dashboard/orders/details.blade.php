                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            ...
                            <tr>
                                ...
                                <td class="fw-bolder text-end">{{$order->date_added}}</td>
                            </tr>
                            <!--end::Date-->
                            ...
                            <tr>
                                ...
                                <td class="fw-bolder text-end">Delivery - Flat Shipping Rate</td>
                            </tr>
                            <!--end::Date-->
                            </tbody>
                            <!--end::Table body-->
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            ...
                            <tr>
                                ...
                                <td class="fw-bolder text-end">
                                    <div class="d-flex align-items-center justify-content-end">
                                        ...
                                        <!--begin::Name-->
                                        <a href="#" class="text-gray-600 text-hover-primary">   {{$order->coustomer_name}}</a>
                                        <!--end::Name-->
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="fw-bolder text-end">
                                    <a href="#" class="text-gray-600 text-hover-primary">  {{$order->coustomer_email}}</a>
                                </td>
                            </tr>
                            <!--end::Payment method-->
                            <!--begin::Date-->
                            <tr>
                                ...
                                <td class="fw-bolder text-end">  {{$order->coustomer_phone}}</td>
                            </tr>
                            <!--end::Date-->
                            </tbody>
                            <!--end::Table body-->
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                            ...
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <div class="card-body pt-0">{{$order->user_location}}</div>
                            <!--end::Card body-->
                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                    ...
                                    @foreach($order_products as $product)
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#" class="symbol symbol-50px">
                                                    <span class="symbol-label" style="background-image:url({{$product->product_image}});"></span>
                                                </a>
                                                <!--end::Thumbnail-->
                                                <!--begin::Title-->
                                                <div class="ms-5">
                                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="fw-bolder text-gray-600 text-hover-primary">Product 1</a>
                                                    <div class="fs-7 text-muted">Delivery Date: {{$order->delivery_date}}</div>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                        </td>
                                        ...
                                        <!--end::SKU-->
                                        <!--begin::Price-->
                                        <td class="text-end">{{$product->base_price}}</td>
                                        <!--end::Price-->
                                        <!--begin::Total-->
                                        <td class="text-end">{{$product->base_price}}</td>
                                        <!--end::Total-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-dark fs-3 fw-boldest text-end">{{$Total + 5}}</td>
                                    </tr>
                                    <!--end::Grand total-->
                                    </tbody>
                                    <!--end::Table head-->
