        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                ...
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-100px">رقم الطلبية</th>
                    <th class="min-w-175px">الزبون</th>
                    <th class="text-end min-w-70px">حالة الطلب</th>
                    <th class="text-end min-w-100px">المجموع</th>
                    <th class="text-end min-w-100px">تاريخ الاضافة</th>
                ...
                <tr>
                    ...
                    <td data-kt-ecommerce-order-filter="order_id">
                        <a href="{{route('orders.show', $order->id)}}" class="text-gray-800 text-hover-primary fw-bolder">{{$order->id}}</a>
                    </td>
                    <!--end::Order ID=-->
                    <!--begin::Customer=-->
                    <td>
                        <div class="d-flex align-items-center">
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{$order->coustomer_name}}</a>
                                <!--end::Title-->
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="text-end" data-order="2022-02-07">
                        <span class="fw-bolder">{{$order->date_added}}</span>
                    </td>
                    <!--end::Date Added=-->
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="{{route('orders.show', $order->id)}}" class="menu-link px-3">عرض</a>
                            </div>
                             <!--end::Menu item-->
                            <!--begin::Menu item-->
