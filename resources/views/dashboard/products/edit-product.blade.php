...
@section('content')
    <!--begin::Form-->
    <form id="kt_ecommerce_add_product_form" method="POST" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data" action ="{{route('products.update', $product->id)}}">
        @csrf
        @method('PUT')
        <!--begin::Aside column-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="product_name" class="form-control mb-2 @error('product_name') is-invalid @enderror" placeholder="Product name" value="{{$product->product_name  ?? old('product_name')}}" />
                                    @error('product_name')
                                ...
                                <div>
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <textarea id="product_description" class="form-control mb-2 @error('product_description') is-invalid @enderror"  name="product_description" rows="4" cols="50" placeholder="product description">{{$product->product_description  ?? old('product_description')}}</textarea>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="base_price" class="form-control mb-2 @error('base_price') is-invalid @enderror" placeholder="Product price" value="{{$product->base_price  ?? old('base_price')}}" />
                                    @error('base_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="sku" class="form-control mb-2  @error('sku') is-invalid @enderror" placeholder="SKU Number" value="{{$product->sku  ?? old('sku')}}" />
                                    @error('sku')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex gap-3">
                                        <input type="number" name="Quantity" class="form-control mb-2 @error('Quantity') is-invalid @enderror"  value="{{$product->Quantity  ?? old('Quantity')}}" />
                                        @error('Quantity')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                </span>
