        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$category->category_name}}</a>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7 fw-bolder">{{$category->category_description}}</div>
                                    <!--end::Description-->
                                </div>
                            </div>
                        </td>
                ...
                @empty
                    <tr>
                        <td>
                        <th class="min-w-200px text-center" colspan="3" > NO DATA..</th>
                        </td>
                    </tr>
                @endforelse
                </tbody>
