            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row">
                        <!--begin::Label-->
                        <label class="required form-label">اسم القسم
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        ...
                        <!--end::Input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">مطلوب اسم القسم ويوصى به ليكون فريدًا.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div>
                        ...
                        <!--end::Editor-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">قم بتعيين وصف للقسم للحصول على رؤية أفضل.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Input group-->
