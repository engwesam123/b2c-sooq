                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-header py-5">
                        ...
                        <div class="card-toolbar">
                            <a href="../../demo1/dist/apps/ecommerce/catalog/products.html" class="btn btn-sm btn-light-primary fw-bolder">Launch eCommerce App</a>
                        </div>
                        <!--end::Toolbar-->
                    </div>
                    <!--end::Header-->
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                            ...
                            <tr>
                                <td>
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#XGT-346</a>
                                </td>
                                <td class="text-end">11 February 2022, 12:26 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#YHD-047</a>
                                </td>
                                <td class="text-end">10 February 2022, 11:34 pm</td>
                                <td class="text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SRR-678</a>
                                </td>
                                <td class="text-end">10 February 2022, 8:26 pm</td>
                                <td class="text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#PXF-534</a>
                                </td>
                                <td class="text-end">10 February 2022, 12:26 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#XGD-249</a>
                                </td>
                                <td class="text-end">9 February 2022, 12:26 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SKP-035</a>
                                </td>
                                <td class="text-end">8 February 2022, 12:26 am</td>
                                <td class="text-end">
                                    <a href="" class="text-dark text-hover-primary">Brian Cox</a>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-dark text-hover-primary">#SKP-567</a>
                                </td>
                                <td class="text-end">5 February 2022, 12:26 am</td>
                                <td class="text-end">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                            ...
                            <tr>
                                ...
                                <!--end::Product ID-->
                                <!--begin::Date added-->
                                <td class="text-end">Apr 15, 2022</td>
                                <!--end::Date added-->
                                <!--begin::Price-->
